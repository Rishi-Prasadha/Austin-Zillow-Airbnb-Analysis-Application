...
def run():
    ...
    bedrooms = get_beds(zipcode)
    guests = get_accomodations(zipcode)
    nights = get_nights()
    ...
    print(f'You can realistically expect to spend between ${nights*(average - stddev):.2f} and ${nights*(average - stddev):.2f}')
